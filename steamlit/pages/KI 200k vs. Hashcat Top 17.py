...
col2.markdown(
    ...
    Datei für das Training zu verwenden, die relativ gleichverteilt ist. Es könnte auch von Vorteil sein, sich vorher zu
...
col4.markdown(
    ...
    Gleichverteiltere Liste, können mehr als doppelt so viele Passwörter aus dem LinkedIn Leak wiederhergestellt werden.
...
col6.markdown(
    ...
    Trainingsdatei orientiert. Über die Hälfte der generierten Passwörter haben eine Komplexität von 10-20 Bit. Das kann
