...
st.set_page_config(
    page_title="KI 750 000 Iterationen",
    page_icon="📈",
...
st.markdown(
    ...
    |----------------------------------------|-------------------|
    | Geknackte Passwörter                   | 2 264 382 (3,74%) |
...
image = "steamlit/images/750k/740k_utf-8_repair_pw_complexity.jpg"
...
image = "steamlit/images/750k/crackedpw_ai_740k_cut_repair_pw_complexity.jpg"
...
image = "steamlit/images/750k/740k_utf-8_repair_normalverteilung_passwortlänge.jpg"
...
image = "steamlit/images/750k/crackedpw_ai_740k_cut_repair_normalverteilung_passwortlänge.jpg"
...
if col15.button("Ab zur Hashcat KI mit 200k Iterationen"):
